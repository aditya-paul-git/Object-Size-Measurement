...
webcam = False
path = 'E:\Course\Python Programs\Python\Object-Size-Measurement\image.jpeg'
...
while True:
    ...
    imgContours, finalContours =  utlis.getContours(img, minArea = 50000, filter = 4)
    if len(finalContours) != 0:
        biggest = finalContours[0][2]
        #print(biggest)
        imgWarp = utlis.warpImg(img, biggest, wp, hp)
        imgContours2, finalContours2 =  utlis.getContours(imgWarp, minArea = 2000, filter = 4, cThr = [50,50], draw = False)
